...
% **************************************************
\newcommand{\thesisTitle}{Exploring aerosol-cloud interaction in the atmospheric column using improved remote sensing methods}
\newcommand{\thesisName}{María Soledad Fernández Carvelo}
\newcommand{\mypriorstudiesPlace}{Universidad de Granada}
\newcommand{\thesisSubject}{PhD. Dissertation}
\newcommand{\thesisDate}{December xx, 2026}
...
\newcommand{\thesisUniversityDepartment}{Departmento de Física Aplicada}	
\newcommand{\thesisUniversityInstitute}{Facultad de Ciencias - Instituto Interuniversitario del Sistema Tierra en Andalucía}
\newcommand{\thesisUniversityGroup}{Grupo de Física de la Atmósfera}
\newcommand{\thesisUniversityCity}{Granada}
\newcommand{\thesisUniversityStreetAddress}{C\textbackslash  Avd. Fuentenueva s/n}	
...
\PassOptionsToPackage{% setup clean thesis style
	...
	bibsys=biber,%
	bibfile=Bibliografia/bibliografia,%
	bibstyle=authoryear,%
}{cleanthesis}
